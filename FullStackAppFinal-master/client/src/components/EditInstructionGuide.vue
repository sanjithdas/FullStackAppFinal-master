          ...
          <div class="col-12 col-md-4">
            ...
            >
              ...
              <b-form-input
                ...
                :state="$v.instructionGuide.title.$dirty ? !$v.instructionGuide.title.$error : null"
            ...
            >
              <b-form-input
                ...
                :state="$v.instructionGuide.author.$dirty ? !$v.instructionGuide.author.$error : null"
            ...
            >
              <b-form-input
                ...
                :state="$v.instructionGuide.category.$dirty ? !$v.instructionGuide.category.$error : null"
            ...
            >
              <b-form-input
                ...
                :state="$v.instructionGuide.image.$dirty ? !$v.instructionGuide.image.$error : null"
            ...
            >
              <b-form-input
                ...
                :state="$v.instructionGuide.youtubeId.$dirty ? !$v.instructionGuide.youtubeId.$error : null"
          ...
          <div class="col-12 col-md-8">
            ...
            >
              <b-form-textarea
                ...
                :state="$v.instructionGuide.equipment.$dirty ? !$v.instructionGuide.equipment.$error : null"
            ...
            >
              <b-form-textarea
                ...
                :state="$v.instructionGuide.instructions.$dirty ? !$v.instructionGuide.instructions.$error : null"
...
export default {
  ...
  async mounted() {
    const instructionGuideId = this.$store.state.route.params
      .instructionGuideId;
    this.instructionGuide = (
